 ...
 */
async function basicMetadataExample() {
  ...
  const setTxn = await manager.prepareSetMetadata({
    accountId,
    key: "user-profile",
 ...
 */
async function metadataWithExpirationExample() {
 ...
 */
async function batchMetadataExample() {
 ...
 */
async function listMetadataExample() {
 ...
 */
async function kycMetadataExample() {
 ...
 */
async function deleteMetadataExample() {
  ...
  await manager.prepareSetMetadata({
    accountId,
    key: "temporary-data",
  ...
  // Later, delete it
  const deleteTxn = await manager.prepareDeleteMetadata(
    accountId,
    "temporary-data"
  );
 ...
 */
async function applicationStateExample() {
  ...
  const config = await manager.getMetadata({
    accountId: appAccountId,
    key: "app-config",
  });
...
async function runAllExamples() {
  try {
    await basicMetadataExample();
    await metadataWithExpirationExample();
    await batchMetadataExample();
    await listMetadataExample();
    await kycMetadataExample();
    await deleteMetadataExample();
    await applicationStateExample();
  } catch (error) {
...
export {
  ...
  metadataWithExpirationExample,
  batchMetadataExample,
  listMetadataExample,
  kycMetadataExample,
  deleteMetadataExample,
