...
export const HORIZON_ERROR_MAP: Record<HorizonResultCode, StellarErrorDetails> =
  {
    op_underfunded: {
      code: "OP_UNDERFUNDED",
      message:
        "The source account does not have enough balance to perform this operation.",
    ...
    op_low_reserve: {
      code: "OP_LOW_RESERVE",
      message:
        "The account does not have enough XLM to meet the minimum reserve.",
    ...
    op_not_authorized: {
      ...
      action:
        "Ensure the account is authorized to hold or transact this asset.",
    },
