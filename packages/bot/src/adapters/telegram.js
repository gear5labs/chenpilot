...
const DASHBOARD_URL =
  ...
  `${process.env.API_BASE_URL || "http://localhost:2333"}/dashboard`;
const HORIZON_URL =
...
function isDM(ctx) {
  var _a;
  return (
    ((_a = ctx.chat) === null || _a === void 0 ? void 0 : _a.type) === "private"
  );
}
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      this.bot.use((ctx, next) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          var _a, _b, _c;
          const userId =
            (_a = ctx.from) === null || _a === void 0 ? void 0 : _a.id;
      ...
      this.bot.command("trustline", (ctx) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          try {
            ...
            const op = yield (0, sdk_core_1.createTrustlineOperation)(
              assetCode,
              assetIssuer
            );
          ...
          yield (0, performanceProfiler_1.withPerformanceProfiling)(
            ...
            () =>
              __awaiter(this, void 0, void 0, function* () {
                ...
                try {
                  const result = yield this.verificationService.verifyAsset(
                    assetCode,
                    issuerAddress
                  );
                  const statusEmoji =
      ...
      this.bot.use((ctx, next) =>
        __awaiter(this, void 0, void 0, function* () {
          ...
          const text =
            ((_b = ctx.message) === null || _b === void 0 ? void 0 : _b.text) ||
            "";
